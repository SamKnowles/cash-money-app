                        ...
                        <div className='pro-act-income-wrapper'>
                            <div className='projected-income-wrapper'>
                                ...
                                <div className='inc-wrapper-wrapper'>
                                    ...
                                    <div className="income-cat-wrapper">
                                        ...
                                        <div className='dif-wrapper' style={budget.income.projected + budget.extraIncome.projected > 0 ? { color: "green" } : { color: "red" }}>${(budget.income.projected + budget.extraIncome.projected)}</div>
                                    </div>
                                </div>
                            </div>
                            <div className='actual-income-wrapper'>
                                ...
                                <div className='inc-wrapper-wrapper'>
                                    ...
                                    <div className="income-cat-wrapper">
                                        <h6>Total monthly income</h6>
                                        <div className='dif-wrapper' style={budget.income.actual + budget.extraIncome.actual > 0 ? { color: "green" } : { color: "red" }}>${(budget.income.actual + budget.extraIncome.actual)}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
